...
Azure module to deploy a [Azure Stop/Start with Automation](https://docs.microsoft.com/en-us/azure/xxxxxxx).
...
| [azurecaf_name.automation_stop_start](https://registry.terraform.io/providers/claranet/azurecaf/latest/docs/data-sources/name) | data source |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| allowed\_cidrs | List of allowed CIDR ranges to access the Azure Stop/Start with Automation resource. | `list(string)` | `[]` | no |
| allowed\_subnet\_ids | List of allowed subnets IDs to access the Azure Stop/Start with Automation resource. | `list(string)` | `[]` | no |
| client\_name | Client name/account used in naming. | `string` | n/a | yes |
| custom\_name | Custom Azure Stop/Start with Automation, generated if not set. | `string` | `""` | no |
...
| public\_network\_access\_enabled | Whether the Azure Stop/Start with Automation is available from public network. | `bool` | `false` | no |
